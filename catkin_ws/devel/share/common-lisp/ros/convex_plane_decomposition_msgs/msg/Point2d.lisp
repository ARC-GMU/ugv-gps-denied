...
(cl:defmethod cl:initialize-instance :after ((m <Point2d>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Point2d)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name convex_plane_decomposition_msgs-msg:<Point2d> is deprecated: use convex_plane_decomposition_msgs-msg:Point2d instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Point2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader convex_plane_decomposition_msgs-msg:x-val is deprecated.  Use convex_plane_decomposition_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Point2d>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader convex_plane_decomposition_msgs-msg:y-val is deprecated.  Use convex_plane_decomposition_msgs-msg:y instead.")
  (y m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Point2d>)))
  ...
  "convex_plane_decomposition_msgs/Point2d")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Point2d)))
  "Returns string type for a message object of type 'Point2d"
  "convex_plane_decomposition_msgs/Point2d")
