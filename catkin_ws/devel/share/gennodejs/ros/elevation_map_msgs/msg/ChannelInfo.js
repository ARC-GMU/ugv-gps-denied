...
class ChannelInfo {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.string(obj.channels, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ChannelInfo(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [channels]
    data.channels = _arrayDeserializer.string(buffer, bufferOffset, null)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChannelInfo(null);
